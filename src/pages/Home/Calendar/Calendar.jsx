          ...
          {days.map((day, index) => (
            <div
              ...
              className={`p-2 rounded-md ${
                day === currentDate.getDate() && currentDate.getMonth() === new Date().getMonth() && currentDate.getFullYear() === new Date().getFullYear()
                  ? 'bg-blue-500 text-white'
                  : day ? 'hover:bg-gray-200 cursor-pointer' : 'text-gray-300'
              }`}
            >
              {day || ''}
            </div>
