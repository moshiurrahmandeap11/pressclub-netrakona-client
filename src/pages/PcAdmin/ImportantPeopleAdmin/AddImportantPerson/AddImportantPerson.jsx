...
const AddImportantPerson = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!title || !name || !designation || !image) {
    ...
    try {
      ...
      alert('সফলভাবে নতুন ব্যক্তির তথ্য যোগ করা হয়েছে!');
      setTitle('');
      setName('');
      setDesignation('');
      setImage(null);
  ...
  return (
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Title */}
        <div>
          <label className="block text-lg font-medium text-gray-700 mb-2">শিরোনাম</label>
          <input
            type="text"
            value={title}
        ...
        {/* Designation */}
        <div>
          <label className="block text-lg font-medium text-gray-700 mb-2">পদবি</label>
          <input
            type="text"
            value={designation}
        ...
        <div className="pt-4">
          ...
          >
            {isUploading ? 'ছবি আপলোড হচ্ছে...' : isSubmitting ? 'তথ্য যোগ করা হচ্ছে...' : 'ব্যক্তি যোগ করুন'}
          </button>
        </div>
      </form>
    </div>
...
export default AddImportantPerson;
